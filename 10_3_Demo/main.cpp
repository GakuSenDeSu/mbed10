...
void FXOS8700CQ_readRegs(int addr, uint8_t * dataF, int lenF);
void FXOS8700CQ_writeRegs(uint8_t * dataF, int lenF);
...
int main() {
   ...
   dataF[1] |= 0x01;
   dataF[0] = FXOS8700Q_CTRL_REG1;
   FXOS8700CQ_writeRegs(dataF, 2);
   //wifi
...
void FXOS8700CQ_readRegs(int addr, uint8_t * dataF, int lenF) {
   ...
   i2c.read(m_addr, (char *)dataF, lenF);
}

void FXOS8700CQ_writeRegs(uint8_t * dataF, int lenF) {
   i2c.write(m_addr, (char *)dataF, lenF);
}
